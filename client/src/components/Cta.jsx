...
const Cta = () => {
  return (
    ...
    <div className="max-pdd-container mx-2 md:mx-auto p-px ">
      <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] ">
        <div className="flexCenter  bg-black/80 text-whtie px-3 py-1.5 ring-1 ring-slate-900/10 gap-1 rounded-full text-xs">
          <img src={assets.rocket} alt="" width={17} className="invert" />
          <span className="text-white"> Trusted by Experts</span>
        </div>
