      ...
      <div className="p-3">
        <div className="flexBetween">
          ...
          <div className="bold-15 text-secondary">
            {currency}{property.price.sale} | {currency}{property.price.rent}.00
        ...
        <div className="flexCenter gap-2 py-2">
            <p className="flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]">
                <img src={assets.bed} alt="facilitiesIcon" width={21}/>{property.facilities.bedrooms}
            </p>

            <p className="flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]">
                <img src={assets.bath} alt="facilitiesIcon" width={21}/>{property.facilities.bathrooms}
            </p>
            
            <p className="flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]">
                <img src={assets.car} alt="facilitiesIcon" width={21}/>{property.facilities.garages}
            </p>

            <p className="flexCenter gap-x-2  pr-4 font-[500]">
                <img src={assets.ruler} alt="facilitiesIcon" width={21}/>{property.area}
            </p>
        </div>
