...
const PropertyDetails = () => {
  ...
  // Booking property if isAvailable
          ...
          <div className="flex flex-col xl:flex-row gap-8 mt-6">
            ...
            <div className="p-4 flex-2 rounded-xl border border-slate-900/10">
              ...
              <div className="flex justify-between items-start my-1">
                <h4 className="h4 text-secondary">{property.property}</h4>
                <div className="flex items-baseline gap-2 text-secondary relative top-1.5">
                  ...
                  <img src={assets.star} alt="start icon" width={18} />
                  <img src={assets.star} alt="start icon" width={18} />
                  <img src={assets.star} alt="start icon" width={18} />
                  <img src={assets.star} alt="start icon" width={18} />
                  <img src={assets.star} alt="start icon" width={18} />
              ...
              <form onSubmit={onSubmitHandler} className=" text-gray-500 bg-secondary/10 rounded-lg px-6 py-4 flex flex-col lg:flex-row gap-4 lg:gap-x-8 max-w-md lg:max-w-full ring-1 ring-slate-900/5 relative mt-10">
            ...
            <div className="flex-1 max-w-sm">
              <div className="p-6 rounded-xl border border-slate-900/10">
                ...
                <div className="text-sm w-80 divide-y divide-gray-500/30 border border-green-500/30 rounded">
                  <div className="flex items-start justify-between p-3">
                    <div>
                      <div className="flex items-center space-x-2">
                        <h5 className="h5">{property.agency.name}</h5>
                        <p className="bg-green-500/20 px-2 py-0.5 rounded-full text-xs text-green-600">
                          Agency
                        </p>
                      </div>
                      <p>Agency Office</p>
